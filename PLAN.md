...
- GitHub CI passed for final source commit `0812894`: 41 unit/service tests, four browser tests, type checks, production web build, and companion build. Run: https://github.com/haoxing-du/porch/actions/runs/34937977096.
- Follow-up: upgrade the checkout/setup-node GitHub Actions from v4 after reviewing their migration notes. CI reports their bundled Node 20 runtime is deprecated and currently forces Node 24. The application itself runs on Node 22 in CI.
